...
public class ProjectDAO implements IProjectDAO {
    ...
    public boolean registerProject(Project newProject) throws DAOException {
        ...
        try {
            ...
            try (PreparedStatement stamentRegisterProject = connection.prepareStatement(queryRegisterProject)) {
    ...
    public boolean updateProject(Project project) throws DAOException {
        ...
        try {
            Connection connection = ConfigDatabase.getConnection();
            try (PreparedStatement stamentUpdateProject = connection.prepareStatement(queryUpdateProject)) {
    ...
    public boolean hideProject(int idProject) throws DAOException {
        ...
        try {
            Connection connection = ConfigDatabase.getConnection();
            try (PreparedStatement statementHide = connection.prepareStatement(queryHideProject)) {
    ...
    public List<Project> getAllActiveProjects() throws DAOException {
        ...
        try {
            Connection connection = ConfigDatabase.getConnection();
            try (PreparedStatement statementGet = connection.prepareStatement(queryGetActive);
...
public List<Project> retrieveAllProjectsIncludingInactive() throws DAOException {
    ...
    try {
        Connection connection = ConfigDatabase.getConnection();
        try (PreparedStatement statementGet = connection.prepareStatement(queryGetAllProjects);
             ResultSet resultSet = statementGet.executeQuery()) {
    ...
    public Project getProjectById(int projectId) throws DAOException {
        ...
        String querySelectById = 
            ...
            "estadoActividad, objetivos, `fecha registro` " +
            "FROM Proyecto " +
            "WHERE idProyecto = ?";
        try (Connection connection = ConfigDatabase.getConnection();
             PreparedStatement preparedStatement =
                     connection.prepareStatement(querySelectById)) {
            ...
            LOG.log(Level.SEVERE,
                    "Error crítico al buscar proyecto por ID", exceptionDB);
            throw new DAOException(
                    "Error al buscar el proyecto con ID: " + projectId,
                    exceptionDB);
        }
    }
    @Override
public boolean reactivateProject(int projectId) throws DAOException {
    ...
    try {
        Connection connection = ConfigDatabase.getConnection();
        try (PreparedStatement statementReactivate = connection.prepareStatement(queryReactivateProject)) {
    ...
    private Project mapRow(ResultSet resultSet) throws SQLException {
        ...
        Date registrationDate = resultSet.getDate("fecha registro");
...
public boolean assignProjectToStudent(String matricula, int idProyecto) throws DAOException {
    ...
    try {
        ...
        try {
            ...
            try (PreparedStatement statementDecrement = connection.prepareStatement(queryDecrementCupo)) {
                statementDecrement.setInt(1, idProyecto);
                statementDecrement.executeUpdate();
            }

            try (PreparedStatement statementDeactivate = connection.prepareStatement(queryDeactivateIfFull)) {
